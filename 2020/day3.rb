...
wire1_coords = draw(wire1)
wire2_coords = draw(wire2)

# puts wire1_coords.inspect
# puts wire2_coords.inspect

crossings = (wire1_coords & wire2_coords)

puts "Crossings ordered by Manhattan distances"
puts crossings.sort_by { |x, y| x.abs + y.abs }.inspect

puts ""

puts "Ordered step counts"
puts crossings.map { |cross| wire1_coords.index(cross) + wire2_coords.index(cross) }.sort.inspect
